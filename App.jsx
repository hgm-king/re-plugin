export default function App() {
  ...
  <>
    <div className="link-container">
      <button id="profile-button" className="link-button hidden"></button>
    </div>
    <div className="data-field small-label">
      <label>Price:</label>
    ...
    <div className="data-field small-label">
      <label>Taxes:</label>
      <span id="monthly-taxes"></span>
    </div>
    <div className="data-field small-label">
      <label>Rental Estimate:</label>
      <span id="monthly-rent"></span>
    </div>
    <div className="data-field small-label">
    ...
    <div className="data-field mid-label">
      <label>Offer:</label>
      <span id="offer"></span>
    </div>
    <div className="slider-container">
      <b id="offer-slider-min"></b>
      <input type="range" id="offer-slider" />
      <b id="offer-slider-max"></b>
    </div>
    <div className="data-field mid-label">
      <label >Rent:</label>
      <span id="rent"></span>
      <input type="number" id="rent-input" className="hidden" placeholder="Provide Rent Here" />
    </div>
    <div id="rent-slider-container" className="slider-container">
      <b id="rent-slider-min"></b>
      <input type="range" id="rent-slider" />
      <b id="rent-slider-max"></b>
    </div>
    <div className="data-field large-label">
      <label>Cash On Cash
        <a
          target="_blank"
          href="https://picayune-hibiscus-f02.notion.site/Ostrich-Plugin-Calculations-89cc6892d4914be6b5c1c7f07cf96d10"
        >(i)</a>:
      </label>
    ...
    <br />
    <div className="link-container">
      <a target="_blank" id="redfin-link">To Redfin</a>
      <a target="_blank" id="realtor-link">To Realtor</a>
    </div>
    <button id="copy-button" className="link-button"></button>
    <a target="_blank" href="https://docs.google.com/forms/d/1E6h7AbJZxitYnMuT1J6eK-x9AA5CpYHE2Dd3qYghZUA/edit">Provide Feedback!</a>
    <p id="message" className="error"></p>
  </>
}
